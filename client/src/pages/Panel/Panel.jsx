...
const addProductSchema = Yup.object().shape({
  ...
  description: Yup.string()
    .max(400, "Descripción máxima 400 caracteres")
        ...
        {({ errors, touched }) => (
          <Form className="panel-form">
            ...
            {errors.title && touched.title ? (
              <div className="panel-form-error">{errors.title}</div>
            ) : null}
            ...
            {errors.description && touched.description ? (
              <div className="panel-form-error">{errors.description}</div>
            ) : null}
            ...
            {errors.price && touched.price ? (
              <div className="panel-form-error">{errors.price}</div>
            ) : null}
